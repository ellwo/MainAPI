...
<div x-data="perfectScroll" id="messages_view" class="relative h-full " @mousemove="update">
        ...
        <div class="text-center">
            ...
            <button v-show="!louding" v-on:click="loadmore" class="mx-auto text-center">المزيد </button>
                    ...
                    <div class="flex mb-4 text-xs message">
                                <div class="flex-2">
                                    <div class="relative w-12 h-12">
                                        ...
                                        <img class="w-12 h-12 mx-auto bg-cover rounded-full sm:w-12 sm:h-12 bg-primary" :src="chatable.avatar" alt="chat-user" />
                                    </div>
                                </div>
...
<div v-if="isitBlocked==true" class="text-xs text-white bg-danger rounded-xl sm:text-sm" >
