<div>
    <div x-data="{opencart:0}" class="blockcart cart-preview active">
        <div class="relative header-cart">
         ...
         --}}
         <a x-on:click="opencart=!opencart"  class="relative" title="My Wishlists">
            <x-bi-cart2 class="w-16 h-16 text-primary-50 dark:text-m_primary"/>
            <span class="absolute top-0 right-0 p-1 rounded-full text-light bg-danger-lighter">{{ $cart->count() }}</span>
         </a>
