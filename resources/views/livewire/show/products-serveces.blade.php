...
<x-button class='mx-auto' wire:click="more_product">
    more
</x-button>
<div class="w-12 h-12 mx-auto text-center" wire:loading >
...
<script type="text/javascript">
    ...
    //             if(total > procount){
    //                 alert((total>procount)  +"   total="+total+"  procount="+procount);
    //                 window.livewire.emit('load-more-product');
    //                 procount={{$procount}};
    //                  }
    ...
    //                     alert("yes");
    //                     var total={{$servtotal}};
    //             var servcount={{$servcount}};

    //             if(total > servcount){
    //                 window.livewire.emit('load-more-product');
    //                  }
    //                     window.livewire.emit('load-more-service');
