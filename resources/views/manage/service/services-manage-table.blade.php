<section x-data='{open_delete:false}'>
    <div class=" relative">
        ...
        <div x-show="open_delete" class="absolute p-8 space-y-4 top-24 right-1/2 flex flex-col bg-white rounded-md">
                ...
                <div>
                    <div class="flex  transition-shadow shadow">
                        ...
                        <select wire:model.lazy='username' wire:change='UsernameUpdated' class="bg-white text-dark dark:text-white dark:bg-dark rounded-2xl ">
                            ...
                            <span class="text-xs text-info rounded-full p-1">{{ "@".$buss->username }} </span></option>
                            @endforeach
                ...
                <div>
                    <div  class="flex rounded-lg transition-shadow shadow">
                        <div class="w-full flex flex-col items-center space-y-2 ">
                           <x-button href="{{ route('service.create',['username'=>$type!='all'&&$type!='useronly'?$username:'me']) }}" class='block w-32' variant="success">
                            اضافة خدمة جديدة
                    ...
                    <tbody class="">
                        ...
                        <tr class="bg-white dark:bg-dark">
                            ...
                            <td class="p-3 ">
                                ...
                                <a href="{{ route('service.edit',['service'=>$product]) }}" class="mx-2 text-gray-400 hover:text-yellow-700">
