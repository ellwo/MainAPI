<div class="header-bottom hidden-sm-down">
    <div class="container">
        <div class="row d-flex align-items-center">
            <div x-data="{opennav:false}" class="rounded-full contentsticky_verticalmenu verticalmenu-main col-lg-3 col-md-1 d-flex" data-textshowmore="Show More" data-textless="Hide" data-desktop_item="4">
                <div x-on:click='opennav=!opennav' class="bg-dark dark:bg-m_primary toggle-nav d-flex align-items-center justify-content-start">
                ...
                <div  class="verticalmenu-content has-showmore show">
                    ...
                    <div x-show='opennav' id="_desktop_verticalmenu" class="block nov-verticalmenu" data-count_showmore="4">
            ...
            <div class="col-lg-9 col-md-11 header-menu d-flex align-items-center justify-content-start">
                <div class="rounded-full dark:bg-m_primary dark:text-m_primary-darker bg-m_primary-dark text-m_primary d-flex justify-content-between w-100 align-items-center">
