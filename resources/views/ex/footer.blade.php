<footer class="footer footer-three">
    <div class="inner-footer">
        <div class="container">
            <div class="row">
                <div class="nov-row footer-top bg-darker "  data-nov-full-width="true">
                    <div class="nov-row-wrap row ">
                        <div class="h-full nov-modules w-fulls col-lg-12 col-md-12 ">
                        <div class="block nov-wrap">
                            <div class="title_block">معنا تسوقكم افضل </div>
            ...
            <button data-toggle="modal" data-target="#popup-subscribe" class="btn btn-secondary effect-btn" name="submitNewsletter" type="submit">
                <span>subscribe</span>
            </button>
          </span>
                                        </div>
                                ...
                                <div class="social-content">
                                    ...
                                    <div id="social_block">
                                        <div class="social">
                                            <ul class="mb-0 list-inline justify-content-end">
                                                <li class="mb-0 list-inline-item"><a href="#" target="_blank"><i class="zmdi zmdi-facebook"></i></a></li>
                                                <li class="mb-0 list-inline-item"><a href="#" target="_blank"><i class="zmdi zmdi-twitter"></i></a></li>
                                                <li class="mb-0 list-inline-item"><a href="#" target="_blank"><i class="zmdi zmdi-youtube-play"></i></a></li>
                                                <li class="mb-0 list-inline-item"><a href="#" target="_blank"><i class="zmdi zmdi-instagram"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <!-- Popup newsletter -->
                                {{-- <div id="popup-subscribe" class="modal fade"  role="dialog" aria-hidden="true">
                            ...
                            <div class="clearfix nov_row-full-width w-100"></div><div class="nov-row footer-center "  data-nov-full-width="true"><div class="nov-row-wrap row">
                        ...
                        <div class="nov-html col-xl-4 col-lg-4 col-md-4">
                            <div class="block">
                                <div class="block_content">
                                    <p class="logo-footer"><img  src="{{ asset('build/images/logoezoom.png') }}" alt="logo" width="167" height="23" /></p>
                        ...
                        <div class="nov-html col-xl-3 col-lg-3 col-md-3">
                            <div class="block">
                                ...
                                <div class="block_content">
                                    <ul>
                                        <li><a href="{{route('profile')}}">حسابي الشخصي</a></li>
                        ...
                        <!-- end /var/www/demo.bestprestashoptheme.com/public_html/savemart/themes/vinova_savemart/modules/novpagemanage/views/source/html.tpl -->
                    </div></div><div class="clearfix nov_row-full-width w-100"></div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 align-items-center justify-content-md-start justify-content-sm-center d-flex pb-xs-max-20 flex-center">
                    <span>
            Copyright © 2022 to {{ date('Y') }} {{ config('app.name') }} . All Rights Reserved
          </span>
                </div>
            </div>
        </div>
