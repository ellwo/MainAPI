...
<div x-show="open" x-ref="userMenu"
                   ...
                   class="@if($totop) top-12 @else bottom-12 @endif absolute right-0 w-48 py-1 bg-white rounded-md shadow-lg  ring-1 ring-black ring-opacity-5 dark:bg-dark focus:outline-none"
                    ...
                    <x-dropdown-link    class="block bg-primary text-primary-darker hover:bg-primary-darker hover:text-primary-light px-4 py-2 text-sm text-gray-700 transition-colors dark:text-light dark:hover:bg-primary" href="{{route('profile')}}" role="menuitem">
