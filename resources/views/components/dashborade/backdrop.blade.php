...
@click="isPanelOpen{{$name}} = false" class="fixed inset-0 z-10 bg-primary-darker" style="opacity: 0.5"
...
<div class="absolute left-0 p-2 transform -translate-x-full">
    <!-- Close button -->
    <button @click="isPanelOpen{{$name}} = false"
    ...
    <div class="flex-1 overflow-hidden hover:overflow-y-auto">
        ...
        <div class="flex flex-col h-screen" x-data="{ activeTabe: 'action' }">
            ...
            <div class="flex-1 pt-4 overflow-y-hidden hover:overflow-y-auto">
                ...
                <!-- User tab -->
                <div x-data="{counter:count}" class="space-y-4" x-show.transition.in="activeTabe == 'user'">
                    <template x-for="i in counter" x-key="i">
                        <a href="#" class="block">
                            <div class="flex px-4 space-x-4">
                                <div class="relative flex-shrink-0">
        ...
        <div class="p-4 space-y-4 md:p-8">
            <h6 class="text-lg font-medium text-gray-400 dark:text-light">Mode me to</h6>
