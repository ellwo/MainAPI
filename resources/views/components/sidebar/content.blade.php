...
<x-sidebar.link title="ادارة طلبات المنتجات" href="{{ route('owne-product-orders') }}" :isActive="request()->routeIs('owne-product-orders')">
    <x-slot name="icon">
...
<x-sidebar.link title="ادارة خدماتي " href="{{ route('mange.services',['type'=>'all']) }}" :isActive="request()->routeIs('mange.services')">
    <x-slot name="icon">
...
<x-sidebar.dropdown collapsible="true" title="حساباتي التسويقية " :active="request()->routeIs('bussinses')">
    ...
    <x-slot name="icon" >
        <x-heroicon-s-collection class="w-5 h-5"/>
    </x-slot>
